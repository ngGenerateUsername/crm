...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.apis(RequestHandlerSelectors.basePackage("com.CRM.Backend")) // basePackage permet de demander à Swagger de ne rien documenter en dehors du package "com.esprit.examen".
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder()
				.title("CRM")
				.description("\"CRM Swagger configuration\"")
				.version("1.1.0")
				.build();
	}

...
export default function CheckTableDevis(props: {id: any;}) {
  ...
  useEffect(() => {
    dispatch(AllFactureByCom(props.id) as any);
  }, [dispatch]);
  const { status, record } = useSelector((state: any) => state.AllFactureByComExport);
  ...
  function RedirectToDetailsOffre(id : any) {
    history.push("/facture/details-facture?id="+id);
  }
    ...
    <Card
      ...
      <Drawer
            ...
            >
              ...
              <DrawerContent  >
                <DrawerCloseButton />
                <DrawerHeader>Ajouter Facture</DrawerHeader>
                <DrawerBody>

                <OverviewFacture onClose={onClose} listOffre={listFacture} setListOffre={setListFacture}></OverviewFacture>
                </DrawerBody>
                {/* <DrawerFooter>

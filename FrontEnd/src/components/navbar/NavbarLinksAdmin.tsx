	...
	return (
		<Flex
			...
			boxShadow={shadow}>
								...
								👋&nbsp; Hey, {profiledetail && profiledetail.nom} {profiledetail && profiledetail.prenom} &nbsp;&nbsp; {time}
			...
			<Menu>
				<MenuButton p='0px'>
					<Avatar
						...
						color='white'
						name={profiledetail && profiledetail.nom}
						bg='#11047A'
						size='sm'
						w='40px'
						h='40px'
				...
				<MenuList boxShadow={shadow} p='0px' mt='10px' borderRadius='20px' bg={menuBg} border='none'>
					...
					<Flex flexDirection='column' p='10px'>
						<MenuItem _hover={{ bg: 'none' }} _focus={{ bg: 'none' }} borderRadius='8px' px='14px'>
							<Text fontSize='sm' onClick={myprofile}>Mon profil</Text>
						</MenuItem>
						<MenuItem
							_hover={{ bg: 'none' }}
							_focus={{ bg: 'none' }}

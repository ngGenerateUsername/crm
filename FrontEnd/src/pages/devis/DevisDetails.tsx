...
import OverviewFactureEdit from "./EditDevis";
import OverviewDevisEdit from "./EditDevis";
...
import Invoice from "pages/Invoice/Invoice";
  ...
  const DevisDetails = () => {
	...
	useEffect(() => {
	  dispatch(DetailDevis(id) as any )
	...
	const handleDeleteFacture = () => {
	  dispatch(DeleteDevis(id) as any)
		...
		.then(() => {
		  ...
		  history.push("/commercial/list-devis");
			...
			<TabPanel>
				{factureDetails && 
				  ...
				  <Flex alignItems="center">
					<Box mr={4} w={16} h={14}>
					  <Image
						src={require("assets/img/avatars/devis.png")}
						bg="transparent"
					  />
					</Box>
					<Flex direction="column">
					  <Text color="blue.500" fontWeight="bold" fontSize="xl">
						Devis n° {factureDetails.id}
					  </Text>
					...
					>
					  <AlertDialogOverlay>
						<AlertDialogContent>
						  ...
						  <AlertDialogBody>
							Êtes-vous sûr de vouloir supprimer cette Devis ?
						  </AlertDialogBody>
		...
		<Drawer
              ...
              >
                ...
                <DrawerContent  >
                  ...
                  <OverviewDevisEdit onClose={onClose} factureDetails={factureDetails} setOffresDeFacture={setOffresDeFacture} offresDeFacture={offresDeFacture} setFactureDetails={setFactureDetails}></OverviewDevisEdit>
                  </DrawerBody>
                  {/* <DrawerFooter>
